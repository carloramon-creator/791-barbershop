                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-slate-400 mt-1 font-medium">
                                        {step === 1 ? 'Selecione os serviços desejados' :
                                ...
                                <div className="flex items-center gap-6">
                                    <div className="flex items-center gap-3">
                                        {[1, 2, 3, ...(wizardMode === 'booking' ? [4] : [])].map((s) => (
                                            <div key={s} className="flex items-center">
                                                <div className={cn(
                                                    "w-10 h-10 rounded-xl flex items-center justify-center font-black text-lg transition-all duration-300",
                                                    step >= s
                                                ...
                                                {s !== (wizardMode === 'booking' ? 4 : 3) && (
                                                    <div className={cn("w-8 h-1 mx-2 rounded-full", step > s ? "bg-blue-600" : "bg-slate-800")} />
                                                )}
                                            </div>
                                        ))}
                                    </div>
